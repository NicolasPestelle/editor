...
public class DocumentTest extends TestCase {
    ...
    public void testSelect() throws Exception {
        ...
        assertTrue(Utilitaire.select(new Point(1,1), 8, document).size() == 1);
        assertTrue(Utilitaire.select(new Point(1,1), 8, document).firstElement().getID() == c.getID());
    }
    ...
    public void testSelect2() throws Exception {
        ...
        assertTrue(Utilitaire.select(new Point(1,1), 8, document).size() == 2);
    }
    ...
    public void testConstructorGrid() throws Exception {
        Document document = new Document();
        CreationDocument.DocumentGrille(document, new Point(0,0), 3, 3, 5);
    ...
    public void testConstructorCircle() throws Exception {
        Document document = new Document();
        CreationDocument.DocumentCercle(document, new Point(0,0), 4, 3., 4.);
